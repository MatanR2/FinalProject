...
try:
    # Yahoo Finance Ethereum data
    yahoo_df = pd.read_csv("/content/drive/My Drive/Colab Notebooks/Yahoo_Finance_Ethereum.csv")
    ...
    # Google Trends Ethereum data
    google_df = pd.read_csv("/content/drive/My Drive/Colab Notebooks/Google_Trends_ethereum.csv")
    ...
    sentiment_df = pd.read_csv("/content/drive/My Drive/Colab Notebooks/combined_ethereum_tweets_with_Sentiment_all_months.csv")
    ...
    if len(yahoo_df) == 0 and len(google_df) > 0:
        ...
        yahoo_df = pd.read_csv('Yahoo_Finance_Ethereum.csv')
    ...
    if len(sentiment_df) == 0 and len(google_df) > 0:
        ...
        sentiment_df = pd.read_csv('combined_ethereum_tweets_with_Sentiment_all_months.csv')
    ...
    final_df_complete.to_csv("/content/drive/My Drive/Colab Notebooks/merged_ethereum_data.csv", index=False)
    print("Merged data saved to 'merged_ethereum_data.csv'")
