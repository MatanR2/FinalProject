...
print("Loading data...")
df = pd.read_csv("/content/drive/My Drive/Colab Notebooks/merged_ethereum_data.csv")
...
plt.tight_layout()
plt.savefig('/content/drive/My Drive/Colab Notebooks/baseline_training_history_ethereum.png')
plt.show()
