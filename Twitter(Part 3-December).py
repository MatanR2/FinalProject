json_file3 = "/content/drive/My Drive/Colab Notebooks/december.json"
pip install ijson
...
def process_json_to_csv_chunks(input_file_path, output_dir, chunk_size=100000, prefix="december_"):
    """
    ...
    input_file_path = json_file3
    output_dir = "/content/drive/My Drive/Colab Notebooks/csv_chunks_DECEMBER"  # Directory to store CSV chunk files
...
def process_all_csv_files(input_dir, output_dir, file_prefix="december_"):
    """
...
input_dir = "/content/drive/My Drive/Colab Notebooks/csv_chunks_DECEMBER"  # Directory containing the CSV files
output_dir = "/content/drive/My Drive/Colab Notebooks/csv_chunks_DECEMBER_filtered"  # Directory to save filtered CSV files
...
def combine_and_sort_csv_files(input_dir, output_file, date_column="timestamp_ms", file_pattern="filtered_december_*.csv"):
    """
...
input_dir = "/content/drive/My Drive/Colab Notebooks/csv_chunks_DECEMBER_filtered"
output_file = "/content/drive/My Drive/Colab Notebooks/combined_sorted_december_data.csv"
